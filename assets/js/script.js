...
const textWa = ""
const pesan = `Tau ga artinya? A itu artinya aku sayang kamu xixixi. Awan, awan apa yang bikin seneng? Awanna be with you AHAHAHA, APAAN SI DARI KEMAREN GOMBALAN DARI GOOGLE CRINGE SEMUAA NJERR gausa dipikirin gombalanya pikirin yang ngirim ajaaa ahaha:>`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Alloo bidadarii, masukinn nama duluu :>',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin nama duluuu aisss :>`)
      }
      return { login }
    }
  }).then((result) => {
